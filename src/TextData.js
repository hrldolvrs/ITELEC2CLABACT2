const TextData = [
  {
    title: "FMovies - Watch Free Movies Online for Free",
    content:
      "Cord-cutting is becoming a huge thing these days. People around the world are tired of paying the massive bills" +
...

  {
    ...
    content:
      "As noted above, Fmovies is a file-sharing website that allows people to watch a wide range of movies and TV shows for free. " +
...

  {
    ...
    content:
      "Fmovies has had a very troubled history. It’s even a surprise that the site is still here today. The site was created in 2016. " +
...

  {
    ...
    content:
      ...
      "accessing Fmovies has become quite a challenge for so many people. But" +
      ...
      "actually one simple way of accessing Fmovies from anywhere in the" +
      "world. Simply use a VPN. A VPN is designed to mask your IP and route" +
      "your traffic to a different server. Let’s say for example you are in" +
      "Australia, one of the few countries where Fmovies is blocked. When you" +
      "install a VPN on your device, you can route your traffic to a US" +
      "server. The US is one of the countries where access to Fmovies is" +
      "still not an issue. Once you have done that, it would appear you are" +
      "accessing Fmovies from the US and as such, you will not face the" +
      "blockade put in place in your country. Using a VPN also helps to" +
      "protect your privacy and keep you safe online.",
    textOrder: 1,
  },

  {
    title: "What Are the Pros of Using Fmovies?",
    content:
      "Despite its legal challenges over the years, Fmovies has managed to" +
      "offer excellent value to its fans out there. The site has a lot of" +
      "pros. First, there is a superb variety of content. This is always a" +
      "huge factor when you are gauging the quality of a streaming site." +
      "After all, the last thing you want is to go to a website only to" +
      "realize that there aren’t many movies you are interested in. The" +
      "Fmovies site, even though it has used different domains over the" +
      "years, also looks quite sleek and so easy to use. You can locate" +
      "whatever you want to watch in a matter of minutes. You will also be" +
      "happy to note that the website has a superb trust rating. In essence," +
      "a majority of people who use it don’t often land into any issues." +
      "This, therefore, means the site is relatively safe to use but it is" +
      "always nice to take precautions. Finally, Fmovies is updated very" +
      "regularly. New shows and movies will always be available on the site" +
      "as soon as possible.",
    textOrder: 0,
  },

  {
    ...
    content:
      ...
      "services, Fmovies does not have an official app. Yes, there are some" +
      "apps that claim to be Fmovies but most of them are not genuine. The" +
      "best way would be to just stream directly on your smart TV’s browser." +
      "In case you have a streaming device like a Firestick or an android TV" +
      "box, consider getting a suitable browser to help you access Fmovies.",
    textOrder: 1,
  },

  {
    title: "Should I Be Worried If I Have Used Fmovies Before?",
    content:
      "No, you should not be worried at all. Although most domains associated" +
      "with Fmovies have either been seized or blocked by authorities, users" +
      ...
      "doing it. But since there have been many fake Fmovies sites, chances" +
      "are you may have landed in one of them. Just as a precaution, ensure" +
      "you do regular scans on your device to check if there is any malware" +
      "to remove. But moving forward, always use VPNs when streaming pirated" +
      "materials. It’s just a common-sense decision that goes a long way in" +
      "protecting you. Nevertheless fmovies only store links which then" +
      "points to the data on internet. Fmovies does not store any content or" +
      "video on its own server and only links to it.",
    textOrder: 0,
  },
];
